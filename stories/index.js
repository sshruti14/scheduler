...
storiesOf("InterviewerListItem", module)
  ...
  .add("Edit", () => <Form name="Shruti" interviewers={interviewers} interviewer={interviewer.id} onSave={action("onSave")} onCancel={action("onCancel")}/>)
  ...
  .add("Appointment Booked", () => (
    <Fragment>
      <Appointment
        id={1}
        time="12pm"
        interview={{ student: "Lydia Miller-Jones", interviewer :"Sylivia Palmer"}}
      />
      <Appointment id="last" time="1pm" />
    </Fragment>
  ))